        ...
        <div>
          {!formState.inputValues.listedGame[0] ? (
            ...
            <img
              ...
              src={
                BACKEND_ADDRESS + formState.inputValues.listedGame[0].imageURL
              }
      ...
      <div className="uploadDetails">
        ...
        <div className="conditions">
          ...
          <input
            type="checkbox"
            onClick={(event) =>
              (document.getElementById("sellingPrice").disabled = !event.target
                .checked)
            }
          />
          <label>
          ...
          <input
            type="checkbox"
            onClick={(event) =>
              (document.getElementById("rentalPrice").disabled = !event.target
                .checked)
            }
          />
          <label>
