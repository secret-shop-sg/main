...
function UpdateUser() {
    ...
    const [currentDescription, setNewDescription] = useState("This is my descwiption. I seww stuwff fow the nintendo switch! OwO i wike games wike pokemon a wot! OwO smash bwos too ! OwO i hope to be abwe to buwy and seww games! OwO");
                ...
                {!editUsername ?
                    ...
                    <span>
                        <input
                            ...
                            name="username"
                            onChange={(e) => inputUsernameChangeHandler(e.target.id, e.target.value)}
                        />
                        <span>
                            <button className="saveButton" onClick={usernameHandler}>Save</button>
                        </span>
                    </span>
                }
                <hr></hr>
                ...
                {!editPassword ?
                    ...
                    <span>
                        <input
                            ...
                            className="infoupdater"
                            name="password"
                            onChange={(e) => inputPasswordChangeHandler(e.target.id, e.target.value)}
                        />
                        ...
                        />
                        <span>
                            <button className="saveButton" onClick={passwordHandler}>Save</button>
                        </span>
                    </span>
                }
                <hr></hr>
                ...
                {!editDescription ?
                    ...
                    <span>
                        <textarea
                            ...
                            className="username"
                            name="description"
                            onChange={(e) => inputDescriptionChangeHandler(e.target.id, e.target.value)}
                        />
                        <span>
                            <button className="saveButton" onClick={descriptionHandler}>Save</button>
                        </span>
                    </span>
                }
            </div>
